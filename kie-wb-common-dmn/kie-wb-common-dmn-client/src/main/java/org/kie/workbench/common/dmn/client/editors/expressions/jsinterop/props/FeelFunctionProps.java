...
public class FeelFunctionProps extends FunctionProps {
    ...
    public FeelFunctionProps(final String name, final String dataType, final EntryInfo[] formalParameters, final ExpressionProps expression) {
        super(name, dataType, formalParameters, FunctionKind.FEEL.value());
