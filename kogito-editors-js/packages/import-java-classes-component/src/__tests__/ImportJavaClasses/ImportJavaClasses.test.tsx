...
import { ImportJavaClasses, JavaClass } from "../../components";
import * as _ from "lodash";

describe("ImportJavaClasses component tests", () => {
  test("should render ImportJavaClasses Button component", () => {
    const { container } = render(
      <ImportJavaClasses buttonDisabledStatus={false} sendJavaClassesToEditor={mockSendToGWTEditorCall} />
    );
  ...
  const mockSendToGWTEditorCall = jest.fn((javaClasses: JavaClass[]) => {
    //Do nothing
  });
});
