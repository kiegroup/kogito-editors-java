...
public class MessagePath implements BPMNProperty {
    ...
    public MessagePath(@MapsTo("value") final ScriptTypeListValue value) {
        this.value = value;
    }
    ...
    public boolean equals(Object o) {
        if (o instanceof MessagePath) {
            MessagePath other = (MessagePath) o;
